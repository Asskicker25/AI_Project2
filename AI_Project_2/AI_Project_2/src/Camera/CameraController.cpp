...
#include <Graphics/Timer.h>
 ...
 float CameraController::MOVE_SPEED = 10;
...
void CameraController::HandleMove(float deltaTime)
{
	...
	mCamera->transform.position += mCamera->transform.GetRight() * mMoveDir.x * deltaTime * MOVE_SPEED;
	mCamera->transform.position += mCamera->transform.GetUp() * mMoveDir.y * deltaTime * MOVE_SPEED;
	mCamera->transform.position += mCamera->transform.GetForward() * mMoveDir.z * deltaTime * MOVE_SPEED;
